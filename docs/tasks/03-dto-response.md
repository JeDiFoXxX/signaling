...
**Файл:** `src/main/java/ru/jedifox/safeedu/signaling/dto/SignalingResponseDto.java`
...
**Файл:** `src/test/java/ru/jedifox/safeedu/signaling/dto/SignalingResponseDtoSerializationTest.java`
