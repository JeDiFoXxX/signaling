...
**Файл:** `src/main/java/ru/jedifox/safeedu/signaling/dto/SignalingDto.java`
...
**Файл:** `src/test/java/ru/jedifox/safeedu/signaling/dto/SignalingDtoSerializationTest.java`
