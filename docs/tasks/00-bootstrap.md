...
**Файл:** `src/main/java/ru/jedifox/safeedu/signaling/SignalingApplication.java`
...
server.port=8080
logging.level.ru.jedifox.safeedu.signaling=INFO
```

### 3. Smoke-тест

**Файл:** `src/test/java/ru/jedifox/safeedu/signaling/SignalingApplicationTests.java`
